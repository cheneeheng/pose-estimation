...
# BASE_PATH = '/tmp/realsense_230606/001622070408/230606143529/'
# ca = f'{BASE_PATH}/calib/dev001622070408_calib.json'
# cf = f'{BASE_PATH}/color/1686054934418478864.npy'
# df = f'{BASE_PATH}/depth/1686054934418478864.npy'
# CROP_H = [130, -230]
# CROP_W = [550, -1]
# SUBSAMPLE_RAW_DATA = 3
# SUBSAMPLE_ROT_DATA = 10
...
# BASE_PATH = '/tmp/realsense_230613/001622070408/230613140156/'
# ca = f'{BASE_PATH}/calib/dev001622070408_calib.json'
# cf = f'{BASE_PATH}/color/1686657720461929916.npy'
# df = f'{BASE_PATH}/depth/1686657720461929916.npy'
# CROP_H = [130, -230]
# CROP_W = [550, -1]
# SUBSAMPLE_RAW_DATA = 3
# SUBSAMPLE_ROT_DATA = 10
...
BASE_PATH = '/tmp/realsense_230616/001622070408/230616170954/'
ca = f'{BASE_PATH}/calib/dev001622070408_calib.json'
cf = f'{BASE_PATH}/color/1686928199456432054.npy'
df = f'{BASE_PATH}/depth/1686928199456432054.npy'
CROP_H = [130, -230]
CROP_W = [550, -1]
SUBSAMPLE_RAW_DATA = 3
SUBSAMPLE_ROT_DATA = 10
...
BASE_PATH = '/tmp/realsense_230625/001622070408/230625154718/'
ca = f'{BASE_PATH}/calib/dev001622070408_calib.json'
cf = f'{BASE_PATH}/color/1687700844085001876.npy'
df = f'{BASE_PATH}/depth/1687700844085001876.npy'
CROP_H = [10, -150]
CROP_W = [0, -650]
SUBSAMPLE_RAW_DATA = 3
SUBSAMPLE_ROT_DATA = 10
...
Z_OFFSET = 0
VERTICAL = False
# Plane(point=Point([-1983.46916443,  -420.86093171,  2623.25340909]),
# normal=Vector([-0.86077523, -0.07693598,  0.50313702]))
# [-0.50313702  0.         -0.86077523] 1.6478084077505957
# [[ 0.19731029  0.86077523  0.4691851 ]
#  [-0.86077523 -0.07693598  0.50313702]
#  [ 0.4691851  -0.50313702  0.72575373]]


BASE_PATH = '/tmp/realsense_230626/001622070408/230626131256/'
ca = f'{BASE_PATH}/calib/dev001622070408_calib.json'
cf = f'{BASE_PATH}/color/1687777984214350904.npy'
df = f'{BASE_PATH}/depth/1687777984214350904.npy'
CROP_H = [150, -170]
CROP_W = [0, -550]
SUBSAMPLE_RAW_DATA = 3
SUBSAMPLE_ROT_DATA = 10
...
Z_OFFSET = 0
VERTICAL = False
# Plane(point=Point([-1635.62678462,   -49.48487896,  2623.14769793]),
# normal=Vector([-0.68656311, -0.21030313,  0.69599116]))
# [-0.69599116  0.         -0.68656311] 1.7826813365676628
# [[ 0.40310146  0.68656311  0.60509528]
#  [-0.68656311 -0.21030313  0.69599116]
#  [ 0.60509528 -0.69599116  0.38659541]]


BASE_PATH = '/tmp/realsense_230626/001622070408/230626141617/'
ca = f'{BASE_PATH}/calib/dev001622070408_calib.json'
cf = f'{BASE_PATH}/color/1687781785150525427.npy'
df = f'{BASE_PATH}/depth/1687781785150525427.npy'
CROP_H = [150, -180]
CROP_W = [0, -570]
SUBSAMPLE_RAW_DATA = 3
SUBSAMPLE_ROT_DATA = 10
...
Z_OFFSET = 0
VERTICAL = False
# Plane(point=Point([-1587.02642158,   -77.68257238,  2432.09913669]),
# normal=Vector([-0.64085685, -0.09835458,  0.76133362]))
# [-0.76133362  0.         -0.64085685] 1.6693101709219693
# [[ 0.54450221  0.64085685  0.54112831]
#  [-0.64085685 -0.09835458  0.76133362]
#  [ 0.54112831 -0.76133362  0.35714322]]

BASE_PATH = '/tmp/realsense_230626/001622070408/230626152839/'
ca = f'{BASE_PATH}/calib/dev001622070408_calib.json'
cf = f'{BASE_PATH}/color/1687786124421891461.npy'
df = f'{BASE_PATH}/depth/1687786124421891461.npy'
CROP_H = [150, -180]
CROP_W = [0, -570]
SUBSAMPLE_RAW_DATA = 3
SUBSAMPLE_ROT_DATA = 10
...
Z_OFFSET = 0
VERTICAL = False
# Plane(point=Point([-1696.44610629,   -83.8368129 ,  2609.40361229]),
# normal=Vector([-0.71502632, -0.0860544 ,  0.69378095]))
# [-0.69378095  0.         -0.71502632] 1.656957291476062
