"""
Code runs inference on an image sequence with the crop option.
The crop option crops the detected person in the current frame, 
and runs detection in this region for the next frame.
